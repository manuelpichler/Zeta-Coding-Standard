<?php
/**
 * Zeta_Sniffs_Functions_FunctionCallSignatureSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Zeta_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($next + 1)]['code'] !== T_WHITESPACE &&
            $tokens[($next + 1)]['code'] !== T_CLOSE_PARENTHESIS) {
            // Checking this: $value = my_function([*]...).
